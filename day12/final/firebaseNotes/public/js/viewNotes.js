...
const createCard = note => {
  let colors = ["PaleVioletRed", "Salmon", "MediumAquaMarine", "PowderBlue", "Plum", "LightCoral", "PaleTurquoise"]
  ...
  card += `<div class="column is-one-quarter">
   ...
   card += `<p><strong>Labels:</strong></p>
             ...
             <div class="card-footer-item">
               <div class="footer-item">By <strong>${googleUser.email}</strong> on ${formatDate(note.created)}</div>
            </div>
